      ...
      <section className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg font-semibold text-sky-600">
            Snow Manの聖地を地図で記録して、見つけることができるアプリ
          </p>
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            <Link
              href="/places/index"
              className="inline-flex w-full justify-center rounded bg-blue-500 text-white px-6 py-3 hover:bg-blue-600"
            >
              聖地を探す
            </Link>
            <Link
              href="/places/new"
              className="inline-flex w-full justify-center rounded border border-blue-500 bg-white px-6 py-3 text-blue-500 hover:bg-blue-100"
            >
              聖地を投稿する
            </Link>
          </div>
